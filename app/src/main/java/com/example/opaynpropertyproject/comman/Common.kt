package com.greetupp.extensions
...
//fun View.loadimage(url: String,view: AppCompatImageView)
//{
//    Picasso.get().load(url).placeholder(R.drawable.userplaceholder).into(view)
//}
...
fun TextView.makeMulticolourString(colour:Int,vararg links: Pair<String, View.OnClickListener>  ) {
    val spannableString = SpannableString(this.text)
    for (link in links) {
