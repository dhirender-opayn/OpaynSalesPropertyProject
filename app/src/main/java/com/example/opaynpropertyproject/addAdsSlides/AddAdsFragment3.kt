...
class AddAdsFragment3 : BaseFragment(), View.OnClickListener, ApiResponse,ImageUploadInterface {
...
//                val mProperty_id = propertyFilling.propertyID.toString()
                val mProperty_id = "24"
                serviceViewModel.getMultiPart(Keys.PROPERTY_IMG_ID, mProperty_id)
                    ?.let { fields.add(it) }
