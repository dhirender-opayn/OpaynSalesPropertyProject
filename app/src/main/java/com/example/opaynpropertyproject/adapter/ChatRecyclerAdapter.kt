...
class ChatRecyclerAdapter(val chatlist:ArrayList<ChatFirebaseModel>, val context :Context, val getPositionInterface: GetPositionInterface ) : RecyclerView.Adapter<ChatRecyclerAdapter.ChatViewHolder>() {
